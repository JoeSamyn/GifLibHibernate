...
public class GifController {
    ...
    public String formNewGif(Model model) {
        ...
        model.addAttribute("header", "Upload Gif");
    ...
    public String formEditGif(@PathVariable Long gifId, Model model) {
        ...
        model.addAttribute("header", "Edit Gif");
    ...
    public String updateGif(@Valid Gif gif, MultipartFile file, BindingResult result, RedirectAttributes redirectAttributes) {
